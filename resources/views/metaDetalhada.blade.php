    ...
    <div class="middlecenter-cadastra">
      <div class="row">
        ...
        <input type = "hidden" name="ID_META" value="{{ $page->ID_META }}">
          ...
          <h1 class="subtitulo promeblue"><img src="../img/lupa-yellow.png"> META | {{ $page->DESCRICAO}}</h1>
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            @foreach ($acao as $auxacao)
                  ...
                  @endif
            @endforeach
            <h1 class="subtitulo subtitulo-barra promeblue"> {{ $contadoracaocompleta }} de {{ $contadoracoes }} ações da Meta:</h1>
                ...
                <input type="checkbox" name="accordion" id="accordion-{{ $auxacao->ID_ACAO }}" />
                  ...
                  <div class="accordion-content">
                    ...
                    <div class="col-md-12 justificafonte" >
                      ...
                      <div class="col-md-2" >
                        <P class="texto">{{ $auxacao->DATA_FIM }}</P>
                      </div>
                      <div class="col-md-4">
                      @foreach ($pca as $pcaaux3)
                        @if ($pcaaux3->ID_ACAO == $auxacao->ID_ACAO)
                          <P class="texto">{{ $pcaaux3->DATA_REFERENCIA }}: {{ $pcaaux3->CONSIDERACAO }}</P>
                        @endif
                      @endforeach
                      </div>
                      <hr>
